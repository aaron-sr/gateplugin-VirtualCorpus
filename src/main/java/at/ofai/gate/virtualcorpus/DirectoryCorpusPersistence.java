...
/**
 * Persistence for the DirectoryCorpus LR. The standard Corpus Persistence won't
 * do as it either expects a persistent corpus in which case it must have a
	...
	public void extractDataFromSource(Object source) throws PersistenceException {
		if (!(source instanceof DirectoryCorpus)) {
			throw new UnsupportedOperationException(
					getClass().getName() + " can only be used for " + DirectoryCorpus.class.getName() + " objects!\n"
