 ...
 * @author johann
 */
public abstract class DummyDataStore4Virtuals implements DataStore {
	...
	/**
	 * This does nothing (a dummy datastore cannot be closed ... it exists as long
	 * as the LR it was created for exists).
	 * 
	 * @throws PersistenceException
	 */
	...
	/**
	 * This does nothing. The dummy datastore does not actually hold or manage any
	 * resources. If deleting is supported at all, it will be implemented by the
	 * resource that created this dummy datastore.
	 * 
	 * @param lrClassName
	 * @param lrId
	 * @throws PersistenceException
	...
	public void delete(String lrClassName, Object lrId) throws PersistenceException {
		if (lrClassName.equals("at.ofai.gate.virtualcorpus.DirectorySubsetCorpus")
			...
			throw new UnsupportedOperationException(
					"Datastore " + this.getName() + " delete not supported for class=" + lrClassName + " id=" + lrId);
		}
	}

	/**
	 * This will pass on the resquest to save the language resource to the object
	 * that created this dummy datastore, if the language resource comes from that
	 * object. Otherwise a Persistence Exception is thrown.
	 * 
	 * @param lr
	 * @throws PersistenceException
	 */
	...
	/**
	 * If the object that created this dummy datastore can handle new LRs, the
	 * document will be added to the object. The LR will always be a document. If
	 * adding a new document is not supported a persistence exception is thrown.
	 * 
	 * @param lr
	 * @param secInfo
	 * @return
