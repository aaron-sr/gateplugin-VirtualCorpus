 ...
 */
public class DummyDataStore4DirCorp extends DummyDataStore4Virtuals {
	...
	public LanguageResource adopt(LanguageResource langres) throws PersistenceException {
		...
		if (lr instanceof Document) {
			...
			try {
				Resource newCorpus = Factory.createResource("at.ofai.gate.virtualcorpus.DirectorySubsetCorpus", parms,
	...
	@Override
	public void close() {
		System.err.println("This resource cannot be closed, it will be closed automatically when DirectoryCorpus "
